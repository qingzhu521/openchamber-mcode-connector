#!/usr/bin/env node
/**
 * openchamber-mcode-connector CLI.
 *
 * Default mode:
 *   openchamber-mcode [--port 4096] [--host 127.0.0.1] [--directory /path]
 *
 ...
 * GET /global/health:
 *   openchamber-mcode serve --hostname 127.0.0.1 --port 4096 [--directory /path]
 */
...
if (serveMode) {
  ...
  console.log(`openchamber-mcode-connector listening on ${server.url}`);
